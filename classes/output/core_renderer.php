...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function tcdd_links() {
        ...
        $haslink1 = (empty($PAGE->theme->settings->linkstitle1)) ? false : format_text($PAGE->theme->settings->linkstitle1);
        $link1url = (empty($PAGE->theme->settings->linkstitle1url)) ? false : $PAGE->theme->settings->linkstitle1url;
        $haslink2 = (empty($PAGE->theme->settings->linkstitle2)) ? false : format_text($PAGE->theme->settings->linkstitle2);
        $link2url = (empty($PAGE->theme->settings->linkstitle2url)) ? false : $PAGE->theme->settings->linkstitle2url;
        $haslink3 = (empty($PAGE->theme->settings->linkstitle3)) ? false : format_text($PAGE->theme->settings->linkstitle3);
        $link3url = (empty($PAGE->theme->settings->linkstitle3url)) ? false : $PAGE->theme->settings->linkstitle3url;
        $haslink4 = (empty($PAGE->theme->settings->linkstitle4)) ? false : format_text($PAGE->theme->settings->linkstitle4);
        $link4url = (empty($PAGE->theme->settings->linkstitle4url)) ? false : $PAGE->theme->settings->linkstitle4url;
        $haslink5 = (empty($PAGE->theme->settings->linkstitle5)) ? false : format_text($PAGE->theme->settings->linkstitle5);
        $link5url = (empty($PAGE->theme->settings->linkstitle5url)) ? false : $PAGE->theme->settings->linkstitle5url;
        $haslink6 = (empty($PAGE->theme->settings->linkstitle6)) ? false : format_text($PAGE->theme->settings->linkstitle6);
        $link6url = (empty($PAGE->theme->settings->linkstitle6url)) ? false : $PAGE->theme->settings->linkstitle6url;
        $haslink7 = (empty($PAGE->theme->settings->linkstitle7)) ? false : format_text($PAGE->theme->settings->linkstitle7);
        $link7url = (empty($PAGE->theme->settings->linkstitle7url)) ? false : $PAGE->theme->settings->linkstitle7url;
        $haslink8 = (empty($PAGE->theme->settings->linkstitle8)) ? false : format_text($PAGE->theme->settings->linkstitle8);
        $link8url = (empty($PAGE->theme->settings->linkstitle8url)) ? false : $PAGE->theme->settings->linkstitle8url;
        $haslink9 = (empty($PAGE->theme->settings->linkstitle9)) ? false : format_text($PAGE->theme->settings->linkstitle9);
        $link9url = (empty($PAGE->theme->settings->linkstitle9url)) ? false : $PAGE->theme->settings->linkstitle9url;
        $haslink10 = (empty($PAGE->theme->settings->linkstitle10)) ? false : format_text($PAGE->theme->settings->linkstitle10);
    ...
    public function tcdd_categorymenu()
    {
        ...
        $hascategorymenu1 = (empty($PAGE->theme->settings->categorymenu1)) ? false : format_text($PAGE->theme->settings->categorymenu1);
        $categorymenu1url = (empty($PAGE->theme->settings->categorymenu1url)) ? false : $PAGE->theme->settings->categorymenu1url;

        $hascategorymenu1sub1 = (empty($PAGE->theme->settings->categorymenu1sub1)) ? false : format_text($PAGE->theme->settings->categorymenu1sub1);
        $categorymenu1urlsub1 = (empty($PAGE->theme->settings->categorymenu1sub1url)) ? false : $PAGE->theme->settings->categorymenu1sub1url;
        $hascategorymenu1sub2 = (empty($PAGE->theme->settings->categorymenu1sub2)) ? false : format_text($PAGE->theme->settings->categorymenu1sub2);
        $categorymenu1urlsub2 = (empty($PAGE->theme->settings->categorymenu1sub2url)) ? false : $PAGE->theme->settings->categorymenu1sub2url;
        $hascategorymenu1sub3 = (empty($PAGE->theme->settings->categorymenu1sub3)) ? false : format_text($PAGE->theme->settings->categorymenu1sub3);
        $categorymenu1urlsub3 = (empty($PAGE->theme->settings->categorymenu1sub3url)) ? false : $PAGE->theme->settings->categorymenu1sub3url;
        $hascategorymenu1sub4 = (empty($PAGE->theme->settings->categorymenu1sub4)) ? false : format_text($PAGE->theme->settings->categorymenu1sub4);
        $categorymenu1urlsub4 = (empty($PAGE->theme->settings->categorymenu1sub4url)) ? false : $PAGE->theme->settings->categorymenu1sub4url;
        $hascategorymenu1sub5 = (empty($PAGE->theme->settings->categorymenu1sub5)) ? false : format_text($PAGE->theme->settings->categorymenu1sub5);
        $categorymenu1urlsub5 = (empty($PAGE->theme->settings->categorymenu1sub5url)) ? false : $PAGE->theme->settings->categorymenu1sub5url;
        $hascategorymenu1sub6 = (empty($PAGE->theme->settings->categorymenu1sub6)) ? false : format_text($PAGE->theme->settings->categorymenu1sub6);
        $categorymenu1urlsub6 = (empty($PAGE->theme->settings->categorymenu1sub6url)) ? false : $PAGE->theme->settings->categorymenu1sub6url;
        $hascategorymenu1sub7 = (empty($PAGE->theme->settings->categorymenu1sub7)) ? false : format_text($PAGE->theme->settings->categorymenu1sub7);
        $categorymenu1urlsub7 = (empty($PAGE->theme->settings->categorymenu1sub7url)) ? false : $PAGE->theme->settings->categorymenu1sub7url;
        $hascategorymenu1sub8 = (empty($PAGE->theme->settings->categorymenu1sub8)) ? false : format_text($PAGE->theme->settings->categorymenu1sub8);
        $categorymenu1urlsub8 = (empty($PAGE->theme->settings->categorymenu1sub8url)) ? false : $PAGE->theme->settings->categorymenu1sub8url;
        $hascategorymenu1sub9 = (empty($PAGE->theme->settings->categorymenu1sub9)) ? false : format_text($PAGE->theme->settings->categorymenu1sub9);
        ...
        $hascategorymenu2sub2 = (empty($PAGE->theme->settings->categorymenu2sub2)) ? false : format_text($PAGE->theme->settings->categorymenu2sub2);
        $categorymenu2urlsub2 = (empty($PAGE->theme->settings->categorymenu2sub2url)) ? false : $PAGE->theme->settings->categorymenu2sub2url;
        $hascategorymenu2sub3 = (empty($PAGE->theme->settings->categorymenu2sub3)) ? false : format_text($PAGE->theme->settings->categorymenu2sub3);
        $categorymenu2urlsub3 = (empty($PAGE->theme->settings->categorymenu2sub3url)) ? false : $PAGE->theme->settings->categorymenu2sub3url;
        $hascategorymenu2sub4 = (empty($PAGE->theme->settings->categorymenu2sub4)) ? false : format_text($PAGE->theme->settings->categorymenu2sub4);
        $categorymenu2urlsub4 = (empty($PAGE->theme->settings->categorymenu2sub4url)) ? false : $PAGE->theme->settings->categorymenu2sub4url;
        $hascategorymenu2sub5 = (empty($PAGE->theme->settings->categorymenu2sub5)) ? false : format_text($PAGE->theme->settings->categorymenu2sub5);
        $categorymenu2urlsub5 = (empty($PAGE->theme->settings->categorymenu2sub5url)) ? false : $PAGE->theme->settings->categorymenu2sub5url;
        $hascategorymenu2sub6 = (empty($PAGE->theme->settings->categorymenu2sub6)) ? false : format_text($PAGE->theme->settings->categorymenu2sub6);
        $categorymenu2urlsub6 = (empty($PAGE->theme->settings->categorymenu2sub6url)) ? false : $PAGE->theme->settings->categorymenu2sub6url;
        $hascategorymenu2sub7 = (empty($PAGE->theme->settings->categorymenu2sub7)) ? false : format_text($PAGE->theme->settings->categorymenu2sub7);
        $categorymenu2urlsub7 = (empty($PAGE->theme->settings->categorymenu2sub7url)) ? false : $PAGE->theme->settings->categorymenu2sub7url;
        $hascategorymenu2sub8 = (empty($PAGE->theme->settings->categorymenu2sub8)) ? false : format_text($PAGE->theme->settings->categorymenu2sub8);
        $categorymenu2urlsub8 = (empty($PAGE->theme->settings->categorymenu2sub8url)) ? false : $PAGE->theme->settings->categorymenu2sub8url;
        $hascategorymenu2sub9 = (empty($PAGE->theme->settings->categorymenu2sub9)) ? false : format_text($PAGE->theme->settings->categorymenu2sub9);
        ...
        $hascategorymenu3sub2 = (empty($PAGE->theme->settings->categorymenu3sub2)) ? false :  format_text($PAGE->theme->settings->categorymenu3sub2);
        $categorymenu3urlsub2 = (empty($PAGE->theme->settings->categorymenu3sub2url)) ? false : $PAGE->theme->settings->categorymenu3sub2url;
        $hascategorymenu3sub3 = (empty($PAGE->theme->settings->categorymenu3sub3)) ? false :  format_text($PAGE->theme->settings->categorymenu3sub3);
        $categorymenu3urlsub3 = (empty($PAGE->theme->settings->categorymenu3sub3url)) ? false : $PAGE->theme->settings->categorymenu3sub3url;
        $hascategorymenu3sub4 = (empty($PAGE->theme->settings->categorymenu3sub4)) ? false :  format_text($PAGE->theme->settings->categorymenu3sub4);
        $categorymenu3urlsub4 = (empty($PAGE->theme->settings->categorymenu3sub4url)) ? false : $PAGE->theme->settings->categorymenu3sub4url;
        $hascategorymenu3sub5 = (empty($PAGE->theme->settings->categorymenu3sub5)) ? false :  format_text($PAGE->theme->settings->categorymenu3sub5);
        $categorymenu3urlsub5 = (empty($PAGE->theme->settings->categorymenu3sub5url)) ? false : $PAGE->theme->settings->categorymenu3sub5url;
        $hascategorymenu3sub6 = (empty($PAGE->theme->settings->categorymenu3sub6)) ? false :  format_text($PAGE->theme->settings->categorymenu3sub6);
        $categorymenu3urlsub6 = (empty($PAGE->theme->settings->categorymenu3sub6url)) ? false : $PAGE->theme->settings->categorymenu3sub6url;
        $hascategorymenu3sub7 = (empty($PAGE->theme->settings->categorymenu3sub7)) ? false :  format_text($PAGE->theme->settings->categorymenu3sub7);
        $categorymenu3urlsub7 = (empty($PAGE->theme->settings->categorymenu3sub7url)) ? false : $PAGE->theme->settings->categorymenu3sub7url;
        $hascategorymenu3sub8 = (empty($PAGE->theme->settings->categorymenu3sub8)) ? false :  format_text($PAGE->theme->settings->categorymenu3sub8);
        $categorymenu3urlsub8 = (empty($PAGE->theme->settings->categorymenu3sub8url)) ? false : $PAGE->theme->settings->categorymenu3sub8url;
        $hascategorymenu3sub9 = (empty($PAGE->theme->settings->categorymenu3sub9)) ? false :  format_text($PAGE->theme->settings->categorymenu3sub9);
        ...
        $hascategorymenu4sub2 = (empty($PAGE->theme->settings->categorymenu4sub2)) ? false :  format_text($PAGE->theme->settings->categorymenu4sub2);
        $categorymenu4urlsub2 = (empty($PAGE->theme->settings->categorymenu4sub2url)) ? false : $PAGE->theme->settings->categorymenu4sub2url;
        $hascategorymenu4sub3 = (empty($PAGE->theme->settings->categorymenu4sub3)) ? false :  format_text($PAGE->theme->settings->categorymenu4sub3);
        $categorymenu4urlsub3 = (empty($PAGE->theme->settings->categorymenu4sub3url)) ? false : $PAGE->theme->settings->categorymenu4sub3url;
        $hascategorymenu4sub4 = (empty($PAGE->theme->settings->categorymenu4sub4)) ? false :  format_text($PAGE->theme->settings->categorymenu4sub4);
        $categorymenu4urlsub4 = (empty($PAGE->theme->settings->categorymenu4sub4url)) ? false : $PAGE->theme->settings->categorymenu4sub4url;
        $hascategorymenu4sub5 = (empty($PAGE->theme->settings->categorymenu4sub5)) ? false :  format_text($PAGE->theme->settings->categorymenu4sub5);
        $categorymenu4urlsub5 = (empty($PAGE->theme->settings->categorymenu4sub5url)) ? false : $PAGE->theme->settings->categorymenu4sub5url;
        $hascategorymenu4sub6 = (empty($PAGE->theme->settings->categorymenu4sub6)) ? false :  format_text($PAGE->theme->settings->categorymenu4sub6);
        $categorymenu4urlsub6 = (empty($PAGE->theme->settings->categorymenu4sub6url)) ? false : $PAGE->theme->settings->categorymenu4sub6url;
        $hascategorymenu4sub7 = (empty($PAGE->theme->settings->categorymenu4sub7)) ? false :  format_text($PAGE->theme->settings->categorymenu4sub7);
        $categorymenu4urlsub7 = (empty($PAGE->theme->settings->categorymenu4sub7url)) ? false : $PAGE->theme->settings->categorymenu4sub7url;
        $hascategorymenu4sub8 = (empty($PAGE->theme->settings->categorymenu4sub8)) ? false :  format_text($PAGE->theme->settings->categorymenu4sub8);
        $categorymenu4urlsub8 = (empty($PAGE->theme->settings->categorymenu4sub8url)) ? false : $PAGE->theme->settings->categorymenu4sub8url;
        $hascategorymenu4sub9 = (empty($PAGE->theme->settings->categorymenu4sub9)) ? false :  format_text($PAGE->theme->settings->categorymenu4sub9);
        $categorymenu4urlsub9 = (empty($PAGE->theme->settings->categorymenu4sub9url)) ? false : $PAGE->theme->settings->categorymenu4sub9url;
        $hascategorymenu4sub10 = (empty($PAGE->theme->settings->categorymenu4sub10)) ? false :  format_text($PAGE->theme->settings->categorymenu4sub10);
