...
window.l_forEach = __webpack_require__(3);
...
function tcddTranslateString(selector) {
	...
	l_forEach(elements, function (element) {
		if (currentLang === 'en') {
...
l_forEach(blocks, function (block) {
...
if (frontpage) {
	...
	l_forEach(descriptions, function (description) {
...
var CourseListing = function () {
    function CourseListing(courses) {
        _classCallCheck(this, CourseListing);

        this.courses = courses;
    }

    _createClass(CourseListing, [{
        key: 'create',
        value: function create() {
            ...
            l_forEach(self.courses, function (course) {
                ...
                var metadata = self.metadata(course);
                var description = self.description(course);
                var image = self.image(course);
                var teachers = self.teachers(course);
                ...
                var courseData = {
                    title: title, url: url, image: image, teachers: teachers, metadata: metadata, description: description
                };
        ...
        key: 'metadata',
        value: function metadata(course) {
            var languageName = this.getMetadata(course.querySelector('.summary #language .name'));
            var languageValue = this.getMetadata(course.querySelector('.summary #language .value'));

            var keywordsName = this.getMetadata(course.querySelector('.summary #keywords .name'));
            var keywordsValue = this.getMetadata(course.querySelector('.summary #keywords .value'));

            var presenterName = this.getMetadata(course.querySelector('.summary #presenters .name'));
            var presenterValue = this.getMetadata(course.querySelector('.summary #presenters .value'));

            var estimatedTimeName = this.getMetadata(course.querySelector('.summary #estimatedtime .name'));
            var estimatedTimeValue = this.getMetadata(course.querySelector('.summary #estimatedtime .value'));

            var dateCreatedName = this.getMetadata(course.querySelector('.summary #datecreated .name'));
            var dateCreatedValue = this.getMetadata(course.querySelector('.summary #datecreated .value'));

            var dateUpdatedName = this.getMetadata(course.querySelector('.summary #dateupdated .name'));
            var dateUpdatedValue = this.getMetadata(course.querySelector('.summary #dateupdated .value'));
        ...
        key: 'description',
        value: function description(course) {
            var name = this.getMetadata(course.querySelector('#description'));
            var content = this.getMetadata(course.querySelector('#description-content'));

            return { name: name, content: content };
        }
    }, {
        key: 'image',
        value: function image(course) {
            var courseImage = course.querySelector('.courseimage img');

            return courseImage !== null ? courseImage.src : 'https://picsum.photos/300/300/?image=1056';
        }
    }, {
        key: 'teachers',
        value: function teachers(course) {
            var courseTeachers = course.querySelectorAll('.teachers li a');
        ...
        key: 'getMetadata',
        value: function getMetadata(selector) {
            return selector ? selector.textContent : '';
        }
    }, {
        key: 'makeUI',
        value: function makeUI(course, data) {
            var courseHTML = '';
            course.innerHTML = '';
            ...
            if (Object.keys(data.metadata).length > 0) {
                l_forEach(Object.keys(data.metadata), function (key) {
	...
	_createClass(CategoryMenu, [{
		...
		value: function create() {
			...
			l_forEach(self.categories, function (category) {
				var categoryMenuItems = document.querySelectorAll('.tabs-menu div');

				category.addEventListener('mouseover', function (e) {
					var itemNumber = e.target.id[e.target.id.length - 1];

					l_forEach(categoryMenuItems, function (item) {
						item.style.display = 'none';
					});

					var activeItem = document.querySelector('#menuItem-' + itemNumber);
...
var EnrolPage = function () {
	function EnrolPage(course) {
		_classCallCheck(this, EnrolPage);
	...
	_createClass(EnrolPage, [{
		...
		value: function (_metadata) {
			...
			metadata.toString = function () {
				return _metadata.toString();
			};

			return metadata;
		}(function () {
			var languageName = this.getMetadata(document.querySelector('.summary #language .name'));
			var languageValue = this.getMetadata(document.querySelector('.summary #language .value'));

			var keywordsName = this.getMetadata(document.querySelector('.summary #keywords .name'));
			var keywordsValue = this.getMetadata(document.querySelector('.summary #keywords .value'));

			var presenterName = this.getMetadata(document.querySelector('.summary #presenters .name'));
			var presenterValue = this.getMetadata(document.querySelector('.summary #presenters .value'));

			var estimatedTimeName = this.getMetadata(document.querySelector('.summary #estimatedtime .name'));
			var estimatedTimeValue = this.getMetadata(document.querySelector('.summary #estimatedtime .value'));

			var dateCreatedName = this.getMetadata(document.querySelector('.summary #datecreated .name'));
			var dateCreatedValue = this.getMetadata(document.querySelector('.summary #datecreated .value'));

			var dateUpdatedName = this.getMetadata(document.querySelector('.summary #dateupdated .name'));
			var dateUpdatedValue = this.getMetadata(document.querySelector('.summary #dateupdated .value'));
		...
		value: function description() {
			var name = this.getMetadata(document.querySelector('#description'));
			var content = this.getMetadata(document.querySelector('#description-content'));
		...
		value: function image() {
			var courseImage = document.querySelector('.courseimage img');

			return courseImage !== null ? courseImage.src : 'https://picsum.photos/300/300/?image=543';
		}
	}, {
		key: 'teachers',
		value: function teachers() {
			var courseTeachers = document.querySelectorAll('.teachers li a');
