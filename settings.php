...
/* THEME_tcdd_learn BUILDING NOTES
 * =============================
...
if ($ADMIN->fulltree) {
    // Add the TCDD Learn settings page
    $settings = new theme_boost_admin_settingspage_tabs('themesettingtcdd_learn', get_string('configtitle', 'theme_tcdd_learn'));

    require('settings/general.php');
    require('settings/advanced.php');
    require('settings/newcourses.php');
    require('settings/categorymenu.php');
    require('settings/news.php');
